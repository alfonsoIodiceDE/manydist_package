...
split_i         <- scenario_structure_w_params$df[[3]] |> initial_split(strata=response)
test_i <- split_i |> testing()
train_i <- split_i |> training()
mdist_type_i <- scenario_structure_w_params$mdist_type[[3]]
preset_i     <- scenario_structure_w_params$mdist_preset[[3]]
param_set_i  <- scenario_structure_w_params$param_set[[3]]
