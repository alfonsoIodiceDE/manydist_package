...
truth=peng |> pull(species)

mclust::adjustedRandIndex(cl_int, truth)
mclust::adjustedRandIndex(cl_no_int, truth)
# adjustedRandIndex(cl_gudmm, truth)
mclust::adjustedRandIndex(cl_gow, truth)
mclust::adjustedRandIndex(cl_mod_gow, truth)
mclust::adjustedRandIndex(cl_naive, truth)
