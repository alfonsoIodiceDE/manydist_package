...
niter=50
t_N1_2010=matrix(0,niter,6)
ARIM_N1_2010=matrix(0,niter,6)
...
for(ite in 1:niter){
  ...
  ARIM_N1_2010[ite,1]=adjustedRandIndex(cl_int, truth)
  ARIM_N1_2010[ite,2]=adjustedRandIndex(cl_no_int, truth)
  #adjustedRandIndex(cl_gudmm, truth)
  ARIM_N1_2010[ite,3]=adjustedRandIndex(cl_gow, truth)
  ARIM_N1_2010[ite,4]=adjustedRandIndex(cl_mod_gow, truth)
  ARIM_N1_2010[ite,5]=adjustedRandIndex(cl_naive, truth)
  ARIM_N1_2010[ite,6]= adjustedRandIndex(cl_dkss, truth)
  
  colnames(t_N1_2010)=names
  colnames(ARIM_N1_2010)=names
  print(ite)
}

save(t_N1_2010,file='t_N1_2010.rdata')
save(ARIM_N1_2010,file='ARIM_N1_2010.rdata')
