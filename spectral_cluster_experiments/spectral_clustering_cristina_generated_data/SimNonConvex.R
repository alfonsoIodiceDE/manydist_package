...
n1=n2=250
niter=50
t_N1_NC=matrix(0,niter,6)
ARIM_N1_NC=matrix(0,niter,6)
...
for(ite in 1:niter){
  ...
  ARIM_N1_NC[ite,1]=adjustedRandIndex(cl_int, truth)
  ARIM_N1_NC[ite,2]=adjustedRandIndex(cl_no_int, truth)
  #adjustedRandIndex(cl_gudmm, truth)
  ARIM_N1_NC[ite,3]=adjustedRandIndex(cl_gow, truth)
  ARIM_N1_NC[ite,4]=adjustedRandIndex(cl_mod_gow, truth)
  ARIM_N1_NC[ite,5]=adjustedRandIndex(cl_naive, truth)
  ARIM_N1_NC[ite,6]= adjustedRandIndex(cl_dkss, truth)
  
  colnames(t_N1_NC)=names
  colnames(ARIM_N1_NC)=names
  print(ite)
}

save(t_N1_NC,file='t_N1_NC2.rdata')
save(ARIM_N1_NC,file='ARIM_N1_NC2.rdata')
...
library(tidyverse)
setwd("~/Library/CloudStorage/GoogleDrive-cristina.tortora@sjsu.edu/My Drive/Alfonso project")
...
n1=n2=250
niter=50
t_N1_NC_42=matrix(0,niter,6)
ARIM_N1_NC_42=matrix(0,niter,6)
...
for(ite in 1:niter){
  ...
  D_int = distance_by_method(dfc,method="u_dep",interaction=TRUE)
  t2=proc.time()
  t_N1_NC_42[ite,1]=t2[3]-t1[3]
  t1=proc.time()
  D_no_int = distance_by_method(dfc,method="u_dep",interaction =FALSE)
  t2=proc.time()
  t_N1_NC_42[ite,2]=t2[3]-t1[3]
  t1=proc.time()
  # D_gudmm = distance_by_method(dfc,method="gudmm",interaction=FALSE) |> as.matrix()
  D_naive= distance_by_method(dfc,method="naive",interaction=FALSE)
  t2=proc.time()
  t_N1_NC_42[ite,3]=t2[3]-t1[3]
  t1=proc.time()
  D_gow = distance_by_method(dfc,method="gower",interaction=FALSE)
  t2=proc.time()
  t_N1_NC_42[ite,4]=t2[3]-t1[3]
  
  t1=proc.time()
  D_mod_gow = distance_by_method(dfc,method="mod_gower",interaction=FALSE) |> as.matrix()
  t2=proc.time()
  t_N1_NC_42[ite,5]=t2[3]-t1[3]
  
  t1=proc.time()
  D_dkss = distance_by_method(dfc,method="dkss",interaction=FALSE)
  t2=proc.time()
  t_N1_NC_42[ite,6]=t2[3]-t1[3]
  ...
  ARIM_N1_NC_42[ite,1]=adjustedRandIndex(cl_int, truth)
  ARIM_N1_NC_42[ite,2]=adjustedRandIndex(cl_no_int, truth)
  #adjustedRandIndex(cl_gudmm, truth)
  ARIM_N1_NC_42[ite,3]=adjustedRandIndex(cl_gow, truth)
  ARIM_N1_NC_42[ite,4]=adjustedRandIndex(cl_mod_gow, truth)
  ARIM_N1_NC_42[ite,5]=adjustedRandIndex(cl_naive, truth)
  ARIM_N1_NC_42[ite,6]= adjustedRandIndex(cl_dkss, truth)
  
  colnames(t_N1_NC_42)=names
  colnames(ARIM_N1_NC_42)=names
  print(ite)
}

save(t_N1_NC_42,file='t_N1_NC_42.rdata')
save(ARIM_N1_NC_42,file='ARIM_N1_NC_42.rdata')



boxplot(ARIM_N1_NC_42, main = "", ylab='ARI',
...
n1=n2=250
niter=50
t_N1_NC_48=matrix(0,niter,6)
ARIM_N1_NC_48=matrix(0,niter,6)
...
for(ite in 1:niter){
  ...
  D_int = distance_by_method(dfc,method="u_dep",interaction=TRUE)
  t2=proc.time()
  t_N1_NC_48[ite,1]=t2[3]-t1[3]
  t1=proc.time()
  D_no_int = distance_by_method(dfc,method="u_dep",interaction =FALSE)
  t2=proc.time()
  t_N1_NC_48[ite,2]=t2[3]-t1[3]
  t1=proc.time()
  # D_gudmm = distance_by_method(dfc,method="gudmm",interaction=FALSE) |> as.matrix()
  D_naive= distance_by_method(dfc,method="naive",interaction=FALSE)
  t2=proc.time()
  t_N1_NC_48[ite,3]=t2[3]-t1[3]
  t1=proc.time()
  D_gow = distance_by_method(dfc,method="gower",interaction=FALSE)
  t2=proc.time()
  t_N1_NC_48[ite,4]=t2[3]-t1[3]
  
  t1=proc.time()
  D_mod_gow = distance_by_method(dfc,method="mod_gower",interaction=FALSE) |> as.matrix()
  t2=proc.time()
  t_N1_NC_48[ite,5]=t2[3]-t1[3]
  
  t1=proc.time()
  D_dkss = distance_by_method(dfc,method="dkss",interaction=FALSE)
  t2=proc.time()
  t_N1_NC_48[ite,6]=t2[3]-t1[3]
  ...
  ARIM_N1_NC_48[ite,1]=adjustedRandIndex(cl_int, truth)
  ARIM_N1_NC_48[ite,2]=adjustedRandIndex(cl_no_int, truth)
  #adjustedRandIndex(cl_gudmm, truth)
  ARIM_N1_NC_48[ite,3]=adjustedRandIndex(cl_gow, truth)
  ARIM_N1_NC_48[ite,4]=adjustedRandIndex(cl_mod_gow, truth)
  ARIM_N1_NC_48[ite,5]=adjustedRandIndex(cl_naive, truth)
  ARIM_N1_NC_48[ite,6]= adjustedRandIndex(cl_dkss, truth)
  
  colnames(t_N1_NC_48)=names
  colnames(ARIM_N1_NC_48)=names
  print(ite)
}

save(t_N1_NC_48,file='t_N1_NC_48.rdata')
save(ARIM_N1_NC_48,file='ARIM_N1_NC_48.rdata')



boxplot(ARIM_N1_NC_48, main = "", ylab='ARI',
        las = 2,                # Rotate axis labels for readability
        col = "lightblue",      # Fill color
        border = "darkblue",    # Border color
        outline = TRUE)         # Show outliers
