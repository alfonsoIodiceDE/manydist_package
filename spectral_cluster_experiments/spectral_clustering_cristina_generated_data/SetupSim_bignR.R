...
niter=50
t_N2E=matrix(0,niter,6)
ARIM_N2E=matrix(0,niter,6)
...
for(ite in 1:niter){
  ...
  ARIM_N2E[ite,1]=adjustedRandIndex(cl_int, truth)
  ARIM_N2E[ite,2]=adjustedRandIndex(cl_no_int, truth)
  #adjustedRandIndex(cl_gudmm, truth)
  ARIM_N2E[ite,3]=adjustedRandIndex(cl_gow, truth)
  ARIM_N2E[ite,4]=adjustedRandIndex(cl_mod_gow, truth)
  ARIM_N2E[ite,5]=adjustedRandIndex(cl_naive, truth)
  ARIM_N2E[ite,6]= adjustedRandIndex(cl_dkss, truth)
  
  colnames(t_N2E)=names
  colnames(ARIM_N2E)=names
  print(ite)
}

save(t_N2E,file='t_N2E.rdata')
save(ARIM_N2E,file='ARIM_N2E.rdata')



boxplot(ARIM_N2E, main = "", ylab='ARI',
...
library(mvtnorm)
library(Rmixmod)
names=c('Udep Interaction','Udep','naive','Gower','mod Gower', 'dkss' )
pnum=10
pcat=20
p=pnum+pcat
n=1000
...
niter=50
t_N2_1020=matrix(0,niter,6)
ARIM_N2_1020=matrix(0,niter,6)
...
for(ite in 1:niter){
  ...
  D_int = distance_by_method(dfc,method="u_dep",interaction=TRUE)
  t2=proc.time()
  t_N2_1020[ite,1]=t2[3]-t1[3]
  t1=proc.time()
  D_no_int = distance_by_method(dfc,method="u_dep",interaction =FALSE)
  t2=proc.time()
  t_N2_1020[ite,2]=t2[3]-t1[3]
  t1=proc.time()
  # D_gudmm = distance_by_method(dfc,method="gudmm",interaction=FALSE) |> as.matrix()
  D_naive= distance_by_method(dfc,method="naive",interaction=FALSE)
  t2=proc.time()
  t_N2_1020[ite,3]=t2[3]-t1[3]
  t1=proc.time()
  D_gow = distance_by_method(dfc,method="gower",interaction=FALSE)
  t2=proc.time()
  t_N2_1020[ite,4]=t2[3]-t1[3]
  
  t1=proc.time()
  D_mod_gow = distance_by_method(dfc,method="mod_gower",interaction=FALSE) |> as.matrix()
  t2=proc.time()
  t_N2_1020[ite,5]=t2[3]-t1[3]
  
  t1=proc.time()
  D_dkss = distance_by_method(dfc,method="dkss",interaction=FALSE)
  t2=proc.time()
  t_N2_1020[ite,6]=t2[3]-t1[3]
  ...
  ARIM_N2_1020[ite,1]=adjustedRandIndex(cl_int, truth)
  ARIM_N2_1020[ite,2]=adjustedRandIndex(cl_no_int, truth)
  #adjustedRandIndex(cl_gudmm, truth)
  ARIM_N2_1020[ite,3]=adjustedRandIndex(cl_gow, truth)
  ARIM_N2_1020[ite,4]=adjustedRandIndex(cl_mod_gow, truth)
  ARIM_N2_1020[ite,5]=adjustedRandIndex(cl_naive, truth)
  ARIM_N2_1020[ite,6]= adjustedRandIndex(cl_dkss, truth)
  
  colnames(t_N2_1020)=names
  colnames(ARIM_N2_1020)=names
  print(ite)
}

save(t_N2_1020,file='t_N2_1020.rdata')
save(ARIM_N2_1020,file='ARIM_N2_1020.rdata')
### Generate data from normal plus glm 3
library(mvtnorm)
library(Rmixmod)
names=c('Udep Interaction','Udep','naive','Gower','mod Gower', 'dkss' )
...
niter=50
t_N2_2010=matrix(0,niter,6)
ARIM_N2_2010=matrix(0,niter,6)
...
for(ite in 1:niter){
  ...
  D_int = distance_by_method(dfc,method="u_dep",interaction=TRUE)
  t2=proc.time()
  t_N2_2010[ite,1]=t2[3]-t1[3]
  t1=proc.time()
  D_no_int = distance_by_method(dfc,method="u_dep",interaction =FALSE)
  t2=proc.time()
  t_N2_2010[ite,2]=t2[3]-t1[3]
  t1=proc.time()
  # D_gudmm = distance_by_method(dfc,method="gudmm",interaction=FALSE) |> as.matrix()
  D_naive= distance_by_method(dfc,method="naive",interaction=FALSE)
  t2=proc.time()
  t_N2_2010[ite,3]=t2[3]-t1[3]
  t1=proc.time()
  D_gow = distance_by_method(dfc,method="gower",interaction=FALSE)
  t2=proc.time()
  t_N2_2010[ite,4]=t2[3]-t1[3]
  
  t1=proc.time()
  D_mod_gow = distance_by_method(dfc,method="mod_gower",interaction=FALSE) |> as.matrix()
  t2=proc.time()
  t_N2_2010[ite,5]=t2[3]-t1[3]
  
  t1=proc.time()
  D_dkss = distance_by_method(dfc,method="dkss",interaction=FALSE)
  t2=proc.time()
  t_N2_2010[ite,6]=t2[3]-t1[3]
  ...
  ARIM_N2_2010[ite,1]=adjustedRandIndex(cl_int, truth)
  ARIM_N2_2010[ite,2]=adjustedRandIndex(cl_no_int, truth)
  #adjustedRandIndex(cl_gudmm, truth)
  ARIM_N2_2010[ite,3]=adjustedRandIndex(cl_gow, truth)
  ARIM_N2_2010[ite,4]=adjustedRandIndex(cl_mod_gow, truth)
  ARIM_N2_2010[ite,5]=adjustedRandIndex(cl_naive, truth)
  ARIM_N2_2010[ite,6]= adjustedRandIndex(cl_dkss, truth)
  
  colnames(t_N2_2010)=names
  colnames(ARIM_N2_2010)=names
  print(ite)
}

save(t_N2_2010,file='t_N2_2010.rdata')
save(ARIM_N2_2010,file='ARIM_N2_2010.rdata')
